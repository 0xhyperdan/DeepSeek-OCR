...
def denormalize_coordinates(
    coord: Tuple[float, float], image_width: int, image_height: int
) -> Tuple[int, int]:
...
def process_spotting_response(
    response: str, image_width: int, image_height: int
) -> str:
    ...
    try:
        ...
        for match in matches:
            ...
            if len(coord_matches) == 2:
                ...
                denorm_start = denormalize_coordinates(
                    start_coord, image_width, image_height
                )
                denorm_end = denormalize_coordinates(
                    end_coord, image_width, image_height
                )
        ...
        try:
            ...
            if len(coord_matches) == 2:
                ...
                draw_overlay.rectangle(
                    [x1, y1, x2, y2], fill=color_alpha, outline=(0, 0, 0, 0)
                )
